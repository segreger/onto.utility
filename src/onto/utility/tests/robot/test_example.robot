...
#
#  $ bin/test -s onto.utility -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src onto.utility.testing.ONTO_UTILITY_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/onto/utility/tests/robot/test_example.robot
#
